...
#import "NSString+AllCategories.h"
#import <CommonCrypto/CommonDigest.h>

@implementation NSString (AllCategories)
...
- (NSString *)addTimeStamp {
    ...
    if ([self containsString:@"?"]) {
        return [self stringByAppendingString:[NSString stringWithFormat:@"&timeStamp=%lld",timeStamp]];
    } else {
        return [self stringByAppendingString:[NSString stringWithFormat:@"?timeStamp=%lld",timeStamp]];
    }
}
